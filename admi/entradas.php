...
<!-- /navbar -->
  ...
  <li><a href="tour.php">Tours</a></li>
    ...
    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select id="tipoentrada" class="form-control col-sm-2" name="tipo" >
  ...
  <option value="GASTO">GASTO</option>
    ...
    $consulta =$conexion->consulta("SELECT id_producto,nombre FROM tbl_productos ORDER BY nombre ");
       ...
       <div class="input-group">
        ...
        while ($row = $conexion->extraer_registro()) {
           echo ' 
          <option value="'.encrypt($row[0]).'">'.$row[1].'</option>
          ';
  ...
  echo '</select>
                    ...
                    <div class="form-group">
                       ...
                       <div  id="precioocultar" class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span>
                            </span>
                            <input type="Text" onchange="entradasvalor()" id="precioventas" class="form-control" name="precioventa" placeholder="precio Neto" />
                                   </div>
                    </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="Text" class="form-control" name="factura" placeholder="Numero de Factura" />
                                   </div>
                    </div>
                       <div id="utilidadocultar" class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span>
                            </span>
                            <input type="Text" disabled="" onchange="entradasvalor()" id="utilidades" class="form-control" name="utilidad" placeholder="Utilidad" />
                                   </div>
                    </div>
                       <div id="impuestoocultar" class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span>
                            </span>
                            <input type="Text" disabled="" onchange="entradasvalor()" id="impuestos" class="form-control" name="impuesto" placeholder="impuesto" />
                                   </div>
                    </div>
                <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="Text" disabled="" onchange="entradasvalor()"  id="precios" class="form-control" name="precio" placeholder="Precio de Venta" />
                                   </div>
                    </div>
                    <?php 
echo '     <div class="form-group">
     ...
     ?>
                     ...
                     <div class="form-group">
                        <div class="input-group">
                            ...
                            <textarea rows="4" cols="40" name="descripcion" placeholder="Descripcion" ></textarea> 
                                                               </div>
                    </div>
  ...
  if ($GET['mensaje']=="OK") {
   ...
   # code...
    ...
    <?php 
        ...
        global $conexion ;
  $tamano=10;
    $consulta =$conexion->consulta("SELECT te.id_entrada FROM  tbl_entradas as te  INNER JOIN tbl_productos as tp on tp.id_producto =fk_producto   ");
            $numero_filas = $consulta->num_rows;
             $total_paginas =ceil( $numero_filas / $tamano);
             if (isset($_GET['pagina'])) {
              $pagina=$_GET['pagina'];
              $pagina_inicio=($pagina-1)*$tamano;
  $consulta =$conexion->consulta("SELECT te.id_entrada,tp.nombre,te.cantidad,te.cantidad_predeterminada,te.precio,te.numero_factura,te.fecha,te.descripcion,tp.unidad,te.estado,te.tipo,precio_venta,utilidad,impuesto FROM  tbl_entradas as te  INNER JOIN tbl_productos as tp on tp.id_producto =fk_producto order by te.fecha desc  LIMIT $pagina_inicio,$tamano  ");
              }else{


    $consulta =$conexion->consulta("SELECT te.id_entrada,tp.nombre,te.cantidad,te.cantidad_predeterminada,te.precio,te.numero_factura,te.fecha,te.descripcion,tp.unidad,te.estado,te.tipo,precio_venta,utilidad,impuesto FROM  tbl_entradas as te  INNER JOIN tbl_productos as tp on tp.id_producto =fk_producto order by te.fecha desc  LIMIT 0,$tamano  ");
    ...
    <td data-id="'.encrypt($row[0]).'">'.$row[1].'</td>';
    if ($row[8]=="GRAMOS") {
      echo '
    <td>'.$row[2].' G</td>';
    }
...
<div class="form-group">
  ...
  echo '</select>
                    ...
                    <div class="form-group">
                       ...
                       <div  id="precioocultarlo" class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span>
                            </span>
                            <input type="Text" onchange="entradasvalores()" id="precioventa" class="form-control" name="precioventa" placeholder="precio Neto" />
                                   </div>
                    </div>
                  ...
                  <div id="utilidadocultarlo" class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span>
                            </span>
                            <input type="Text" disabled="" onchange="entradasvalores()" id="utilidad" class="form-control" name="utilidad" placeholder="Utilidad" />
                                   </div>
                    </div>
                       <div id="impuestoocultarlo" class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span>
                            </span>
                            <input type="Text" disabled="" onchange="entradasvalores()" id="impuesto" class="form-control" name="impuesto" placeholder="impuesto" />
                                   </div>
                    </div>
                       <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="Text" disabled="" onchange="entradasvalores()"  id="precio" class="form-control" name="precio" placeholder="Precio de Venta" />
                                   </div>
                    </div>
                    <?php 
echo '     <div class="form-group">
