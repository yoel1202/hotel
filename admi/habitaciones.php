...
<!-- /navbar -->
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="Text" class="form-control" name="n_habitacion" placeholder="Numero de Habitacion" />
                                   </div>
                    </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="Text" class="form-control" name="cantidad" placeholder="Cantidad de Personas" />
                                   </div>
                    </div>
 ...
 <?php if (isset($_GET['mensaje'])) {
  if ($_GET['mensaje']=="OK") {
   ...
   # code...
                    ...
                    <input type="submit" name="guardarhabitacion" value="Guardar" class="btn btn-sm btn-primary btn-block" role="button">
                     </a> </form>
                </div>
 ...
 $tamano=10;
    $consulta =$conexion->consulta("SELECT id_habitacion FROM  tbl_habitaciones order by nombre    ");
            ...
            if (isset($_GET['pagina'])) {
              ...
              $consulta =$conexion->consulta("SELECT id_habitacion,nombre,numero_habitacion,cantidad,estado,descripcion FROM  tbl_habitaciones order by nombre  LIMIT $pagina_inicio,$tamano   ");
    
            }else{

              $consulta =$conexion->consulta("SELECT id_habitacion,nombre,numero_habitacion,cantidad,estado,descripcion FROM  tbl_habitaciones order by nombre  LIMIT 0,$tamano   ");
            }
              ...
              <div class="form-group"  hidden="true">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="Text" class="form-control" id="n_habitacion" name="n_habitacion" placeholder="Numero de Habitacion" />
                                   </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-stats"></span></span>
                           <select class="form-control col-sm-2" id="estados" name="estado">
  <option value="ACTIVADO">ACTIVADO</option>
  <option value="DESACTIVADO">DESACTIVADO</option>
        ...
        <button type="submit"  name="editarhabitaciones" class="btn btn-warning btn-lg" style="width: 100%;"><span class="glyphicon glyphicon-ok-sign"></span>Actualizar</button>
      </div>
    </form>
      </div>
    ...
    <div class="modal-content">
       ...
       <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Esta seguro que quiere eliminar este registro?</div>
        ...
        <div class="modal-footer ">
        <button type="submit"  name="eliminarhabitaciones" class="btn btn-success" ><span class="glyphicon glyphicon-ok-sign"></span>Si</button>
