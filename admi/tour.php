...
<!-- /navbar -->
 ...
 <?php if (isset($_GET['mensaje'])) {
  if ($_GET['mensaje']=="OK") {
   ...
   # code...
                    ...
                    <input type="submit" name="guardartour" value="Guardar" class="btn btn-sm btn-primary btn-block" role="button">
                     </a> </form>
                </div>
 ...
 <div class="row search-header" style="">
    ...
    <?php 
        ...
        global $conexion ;
 $tamano=10;
    $consulta =$conexion->consulta("SELECT id_tours FROM  tbl_tours order by nombre    ");
            ...
            if (isset($_GET['pagina'])) {
              ...
              $consulta =$conexion->consulta("SELECT id_tours,nombre,cantidad,estado,descripcion FROM  tbl_tours order by nombre  LIMIT $pagina_inicio,$tamano   ");
    
            }else{

              $consulta =$conexion->consulta("SELECT id_tours,nombre,cantidad,estado,descripcion FROM  tbl_tours order by nombre  LIMIT 0,$tamano   ");
            }
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
  ...
  <option value="DESACTIVADO">DESACTIVADO</option>
        ...
        <button type="submit"  name="editartour" class="btn btn-warning btn-lg" style="width: 100%;"><span class="glyphicon glyphicon-ok-sign"></span>Actualizar</button>
      </div>
    </form>
      </div>
    ...
    <div class="modal-content">
       ...
       <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Esta seguro que quiere eliminar este registro?</div>
        ...
        <div class="modal-footer ">
        <button type="submit"  name="eliminartour" class="btn btn-success" ><span class="glyphicon glyphicon-ok-sign"></span>Si</button>
