...
<!-- /navbar -->
       ...
       <div class="subnavbar">
        <div class="subnavbar-inner">
          <div class="container">
              ...
              <li class="active"><a href="clientes.php"><i class="fas fa-user"></i><span>Clientes</span> </a> </li>
  ...
  <li><a href="tour.php">Tours</a></li>
    ...
    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="Text" class="form-control" id="correobuscar" name="correo" placeholder="Correo" />
                                   </div>
                    </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="Text" class="form-control" id="telefonobuscar" name="telefono" placeholder="Telefono" />
                                   </div>
                    </div>
    ...
    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="provincia" id="provincias" onchange="canton();" >
    ...
    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="canton" id="cantones" onchange="distrito();" >
                      ...
                      <div class="form-group">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="distrito" id="distritos" onchange="" >
   ...
   <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="Text" class="form-control" name="fecha" placeholder="01/2024" />
                                   </div>
                    </div>
                      <div class="form-group">
                        <div class="input-group">
 ...
 <?php if (isset($_GET['mensaje'])) {
  if ($_GET['mensaje']=="OK") {
   ...
   # code...
                    ...
                    <input type="submit" name="guardarcliente" value="Guardar" class="btn btn-sm btn-primary btn-block" role="button">
                     </a> </form>
                </div>
 ...
 $tamano=10;
    $consulta =$conexion->consulta("SELECT idl_cliente,nombre,apellido,cedula FROM  tbl_clientes order by nombre    ");
            ...
            if (isset($_GET['pagina'])) {
              ...
              $consulta =$conexion->consulta("SELECT idl_cliente,nombre,apellido,cedula,correo,telefono,fax,provincia,canton,distrito,barrio,direccion,tarjeta,fecha_vencimiento,cvc FROM  tbl_clientes order by nombre  LIMIT $pagina_inicio,$tamano   ");
    
            }else{

              $consulta =$conexion->consulta("SELECT idl_cliente,nombre,apellido,cedula,correo,telefono,fax,provincia,canton,distrito,barrio,direccion,tarjeta,fecha_vencimiento,cvc FROM  tbl_clientes order by nombre  LIMIT 0,$tamano   ");
            }
    ...
    <td>'.decrypt($row[12]).'</td>
    <td>'.decrypt($row[13]).'</td>
    <td>'.decrypt($row[14]).'</td>
...
if (isset($_GET['pagina'])) {
  $anterior=$pagina-1;
  if ($anterior>0) {
  echo' <li class="disabled"><a href="clientes.php?pagina='.$anterior.'"><span class="glyphicon glyphicon-chevron-left"></span></a></li>';
  }
 
}
  echo '<li class=""><a href="catalogo.php">1</a></li>';
for ($i=2; $i <=7 ; $i++) { 
 echo '<li class=""><a href="clientes.php?pagina='.$i.'">'.$i.'</a></li>';
}

if (isset($_GET['pagina'])) {
  $siguiente=$pagina+1;
  if ($siguiente<=$total_paginas) {
   echo ' <li><a href="clientes.php?pagina='.$siguiente.'"><span class="glyphicon glyphicon-chevron-right"></span></a></li>';
  }
  
}else{
   echo ' <li><a href="clientes.php?pagina=2"><span class="glyphicon glyphicon-chevron-right"></span></a></li>';
}
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="Text" class="form-control" id="fecha" name="fecha" placeholder="01/2024" />
                                   </div>
                    </div>
                      <div class="form-group">
                        <div class="input-group">
        ...
        <button type="submit"  name="editarcliente" class="btn btn-warning btn-lg" style="width: 100%;"><span class="glyphicon glyphicon-ok-sign"></span>Actualizar</button>
      </div>
    </form>
      </div>
    ...
    <div class="modal-content">
       ...
       <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Esta seguro que quiere eliminar este registro?</div>
        ...
        <div class="modal-footer ">
        <button type="submit"  name="eliminarcliente" class="btn btn-success" ><span class="glyphicon glyphicon-ok-sign"></span>Si</button>
